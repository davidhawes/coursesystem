...
public class Cli {
    ...
    private void updateCourseDetails() {
        System.out.println("Für welche Kurs-ID möchten Sie die Kurstdetails ändern?");
        ...
        } catch (DatabaseException databaseExceptiont){
            System.out.println("Datenbankfehler beim Update: " + databaseExceptiont.getMessage());
    ...
    private void addCourse() {
        ...
        try {
            ...
            System.out.println("Datenbankfehler beim Einfügen: " + databaseExceptiont.getMessage());
        } catch (Exception exception){
